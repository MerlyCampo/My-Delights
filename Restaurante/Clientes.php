...
<head>
    ...
    <title>Gestión de Clientes - My Delights</title>
...
<body>
    ...
    <div class="container">
        ...
        <button class="btn btn-success mb-3" onclick="abrirModalAgregar()">Agregar Cliente</button>
    ...
    <script>
        ...
        function renderizarTabla(clientes) {
          ...
          <tr>
            ...
            <td>
              <button class="btn btn-outline-warning p-1 border-0"
                  style="width: 32px; height: 32px;"
                  title="Editar" onclick='editarCliente(${JSON.stringify(c)})'><i class="bi bi-pencil-square"></i></button>
              <button class="btn btn-outline-danger p-1 border-0"
                  style="width: 32px; height: 32px;"
                  title="Eliminar" onclick='eliminarCliente(${c.id_cliente})'><i class="bi bi-trash3"></button>
            </td>
          </tr>`;
            });
        }
